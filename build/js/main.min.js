...
class Cart extends _js_main_class_js__WEBPACK_IMPORTED_MODULE_0__["Counter"] {
  ...
  bindAll() {
    ...
    const totalCountField = document.querySelector('#total-count'); // *  Функция обработчик по нажатию на кнопку корзины в меню
    ...
    this.cartToggle.addEventListener('click', cartToggleClickHandler, false); // Закрытие корзины по клику на оверлей
