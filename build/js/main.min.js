...
/* harmony import */ var _favorites_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./favorites.js */ "./source/components/js/favorites.js");
/* harmony import */ var _cart_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./cart.js */ "./source/components/js/cart.js");
/* harmony import */ var tui_pagination__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! tui-pagination */ "./node_modules/tui-pagination/dist/tui-pagination.js");
/* harmony import */ var tui_pagination__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(tui_pagination__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _conguest_db_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../conguest.db.json */ "./conguest.db.json");
var _conguest_db_json__WEBPACK_IMPORTED_MODULE_4___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../../conguest.db.json */ "./conguest.db.json", 1);
...
class PageInterface {
  ...
  createPaging() {
    const pagination = new tui_pagination__WEBPACK_IMPORTED_MODULE_3___default.a(this.pagingContainerClass, {
  ...
  bindPaging() {
    ...
    paging.on('afterMove', evt => {
      ...
      _cart_js__WEBPACK_IMPORTED_MODULE_2__["cart"].init();
      _favorites_js__WEBPACK_IMPORTED_MODULE_1__["favorites"].bindAll();
    });
    return paging;
  }
  ...
  renderItems(pageNumber) {
    ...
    const targetData = _conguest_db_json__WEBPACK_IMPORTED_MODULE_4__.slice(pageNumber - indexIndent, targetPages);
...
const paginationOptions = {
  ...
  totalItems: _conguest_db_json__WEBPACK_IMPORTED_MODULE_4__.length,
  itemsPerPage: 12,
  visiblePages: 6,
  initialPage: 1,
  centerAlign: false,
...
/*!***********************************!*\
  !*** ./source/js/main/backend.js ***!
  \***********************************/
/*! exports provided: readDb */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "readDb", function() { return readDb; });
